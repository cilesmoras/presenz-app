    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 transition-transform duration-300 data-[side=left]:-translate-x-full data-[side=left]:data-open:translate-x-0 data-[side=left]:data-closed:-translate-x-full data-[side=right]:translate-x-full data-[side=right]:data-open:translate-x-0 data-[side=right]:data-closed:translate-x-full [&>button]:hidden"
          style={
            {
